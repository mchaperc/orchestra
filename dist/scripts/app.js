...
(function () {
  ...
  //   $('.app').prepend(JST.application());
  // });
})();
  
});

require.register("require", function(exports, require, module){
...
require.register("views/welcome", function(exports, require, module){
  'use strict';

Object.defineProperty(exports, '__esModule', {
	value: true
});
require(backbone.marionette.dust);
...
var WelcomeView = new CompositeView();
